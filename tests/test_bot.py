...
class TestDJBot:
    ...
    def test_init(self, mock_config: BotConfig) -> None:
        """Test bot initialization."""
        bot = DJBot(mock_config)
    ...
    def test_get_config(self, mock_config: BotConfig) -> None:
        """Test getting bot configuration."""
        bot = DJBot(mock_config)
        assert bot.get_config() == mock_config

    def test_get_voice_client_none(self, mock_config: BotConfig) -> None:
        """Test getting voice client when not connected."""
        bot = DJBot(mock_config)
        assert bot.get_voice_client() is None

    def test_is_streaming_false(self, mock_config: BotConfig) -> None:
        """Test is_streaming returns False when not streaming."""
        bot = DJBot(mock_config)
        assert not bot.is_streaming()

    def test_is_streaming_with_voice_client_not_playing(self, mock_config: BotConfig) -> None:
    ...
    def test_is_streaming_true(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_on_ready(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cleanup_with_voice_client(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cleanup_without_voice_client(self, mock_config: BotConfig) -> None:
    ...
    def test_commands_registered(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_join_command_not_in_voice(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_join_command_already_connected(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_leave_command_not_connected(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_play_command_not_connected(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stop_command_not_connected(self, mock_config: BotConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stop_command_not_playing(self, mock_config: BotConfig) -> None:
